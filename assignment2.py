...
# Maximization of the conditional likelihood function
result_cond = minimize(neg_log_likelihood, initial_params, args=(indpro_data['log_diff'].dropna(), cond_loglikelihood_ar7), method='L-BFGS-B')

# Maximization of the unconditional likelihood function
result_uncond = minimize(neg_log_likelihood, initial_params, args=(indpro_data['log_diff'].dropna(), uncond_loglikelihood_ar7), method='L-BFGS-B')
